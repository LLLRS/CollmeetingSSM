...
<head>
    ...
    <script src="../../../resource/js/WdatePicker.js"></script>
    <style>
        .page-content{
            width:830px;
            position: absolute;
...
<div class="page-body">
    ...
    <div class="page-content">
        ...
        <form action="/coolmeetting/searchmeeting" method="post">
            <fieldset>
                <legend>搜索会议</legend>
            ...
            <div class="pager-header">
                ...
                <div class="header-nav">
                    <a type="button" class="clickbutton"
                       href="/coolmeetting/searchmeeting?page=1&meetingname=${meetingname}&roomname=${roomname}&reservername=${reservername}&reservefromdate=${reservefromdate}&reservetodate=${reservetodate}&meetingfromdate=${meetingfromdate}&meetingtodate=${meetingtodate}">首页</a>
                    <c:choose>
                        <c:when test="${page>1}">
                            <a type="button" class="clickbutton"
                               href="/coolmeetting/searchmeeting?page=${page-1}&meetingname=${meetingname}&roomname=${roomname}&reservername=${reservername}&reservefromdate=${reservefromdate}&reservetodate=${reservetodate}&meetingfromdate=${meetingfromdate}&meetingtodate=${meetingtodate}">上页</a>
                        </c:when>
                    ...
                    <c:choose>
                        <c:when test="${page<totalPage}">
                            <a type="button" class="clickbutton"
                               href="/coolmeetting/searchmeeting?page=${page+1}&meetingname=${meetingname}&roomname=${roomname}&reservername=${reservername}&reservefromdate=${reservefromdate}&reservetodate=${reservetodate}&meetingfromdate=${meetingfromdate}&meetingtodate=${meetingtodate}">下页</a>
                        </c:when>
                        <c:otherwise>
                            下页
                        </c:otherwise>
                    ...
                    <a type="button" class="clickbutton"
                       href="/coolmeetting/searchmeeting?page=${totalPage}&meetingname=${meetingname}&roomname=${roomname}&reservername=${reservername}&reservefromdate=${reservefromdate}&reservetodate=${reservetodate}&meetingfromdate=${meetingfromdate}&meetingtodate=${meetingtodate}">末页</a>
                    <form action="/coolmeetting/searchmeeting" style="display: inline" method="post">
