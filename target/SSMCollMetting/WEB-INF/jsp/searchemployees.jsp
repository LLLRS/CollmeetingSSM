...
<div class="page-body">
    ...
    <div class="page-content">
        ...
        <form action="/coolmeetting/serachemp" method="post">
            <fieldset>
                <legend>搜索会议</legend>
            ...
            <div class="pager-header">
                ...
                <div class="header-nav">
                    <a type="button" class="clickbutton"
                       href="/coolmeetting/serachemp?page=1&status=${status}&employeename=${employeename}">首页</a>
                    <c:choose>
                        <c:when test="${page>1}">
                            <a type="button" class="clickbutton"
                               href="/coolmeetting/serachemp?page=${page-1}&status=${status}&employeename=${employeename}">上页</a>
                        </c:when>
                        <c:otherwise>
                            上页
                        </c:otherwise>
                    ...
                    <c:choose>
                        <c:when test="${page<totalPage}">
                            <a type="button" class="clickbutton"
                               href="/coolmeetting/serachemp?page=${page+1}&status=${status}&employeename=${employeename}">下页</a>
                        </c:when>
                        <c:otherwise>
                            下页
                        </c:otherwise>
                    ...
                    <a type="button" class="clickbutton"
                       href="/coolmeetting/serachemp?page=${totalPage}&status=${status}&employeename=${employeename}">末页</a>
                    <form action="/coolmeetting/serachemp" method="post" style="display: inline">
        ...
        <table class="listtable">
            ...
            <c:forEach items="${list}" var="emp">
                <tr>
                    ...
                    <td>${emp.email}</td>
                    <td>
                        <form method="post" action="/coolmeetting/serachemp">
                            <input type="hidden" name="employeename" value="${employeename}">
