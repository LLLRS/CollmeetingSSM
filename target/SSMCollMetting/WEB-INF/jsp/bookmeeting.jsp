...
<head>
    ...
    <script type="application/javascript">
        ...
        function body_load() {
            ...
            $.post("/coolmeetting/getalldepjson", function (msg) {
...
//            }
            ...
            $.post("/coolmeetting/getempbydepid", {departmentid: departmentid}, function (msg) {
                for (var i = 0; i < msg.length; i++) {
                    var item = msg[i];
...
<div class="page-body">
    ...
    <div class="page-content">
        ...
        <form action="/coolmeetting/dobookmeeting" method="post">
            <fieldset>
                <legend>会议信息</legend>
